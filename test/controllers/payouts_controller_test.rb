...
class PayoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payout" do
    assert_difference("Payout.count") do
      post payouts_url, params: { payout: { account_number: @payout.account_number, amount: @payout.amount, currency: @payout.currency, fund_account_id: @payout.fund_account_id, mode: @payout.mode, purpose: @payout.purpose } }
    end
  ...
  test "should update payout" do
    patch payout_url(@payout), params: { payout: { account_number: @payout.account_number, amount: @payout.amount, currency: @payout.currency, fund_account_id: @payout.fund_account_id, mode: @payout.mode, purpose: @payout.purpose } }
